...
class AndroidCameraManagerImpl implements CameraManager {
    ...
    private static final long VAL_WAIT_DONE_POST_DELAY = 10L;
    private static final long VAL_WAIT_DONE_RELEASE_TIMEOUT = 3000L;
    ...
    private class CameraHandler extends Handler {
        ...
        public boolean waitDone() {
            ...
            synchronized (waitDoneLock) {
                mCameraHandler.postDelayed(unlockRunnable, VAL_WAIT_DONE_POST_DELAY);
                try {
                    waitDoneLock.wait(VAL_WAIT_DONE_RELEASE_TIMEOUT);
    ...
    public class AndroidCameraProxyImpl implements CameraManager.CameraProxy {
        ...
        public Parameters getParameters() {
            /* SPRD: while parameter is not dirty ,no need for get new data */
            if (mParametersIsDirty) {
