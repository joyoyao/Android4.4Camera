...
public class WideAnglePanoramaUI implements
    ...
    public WideAnglePanoramaUI(
        ...
        mRootView.findViewById(R.id.btn_camera_setting).setVisibility(View.INVISIBLE);
        ...
        mModuleSwitcherView.setCurrentIndex(ModuleSwitcher.WIDE_ANGLE_PANO_MODULE_INDEX);
    }

    public void onStartCapture() {
        hideSwitcher();
        if (mRootView.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            mShutterButton.setImageResource(R.drawable.btn_shutter_recording_land);
        } else {
            mShutterButton.setImageResource(R.drawable.btn_shutter_recording_port);
        }
    ...
    public void onStopCapture() {
        ...
        updateControlsRes(mRootView.getResources().getConfiguration().orientation);
    ...
    public void showPreviwThumb() {
        mEnablePreviwThumb = true;
        mPreviewThumb.setVisibility(View.VISIBLE);
    }

    public void hidePreviwThumb() {
        mEnablePreviwThumb = false;
    ...
    public void showUI() {
        ...
        mCameraControls.invisibleBackground();
    }
...
//        mShutterButton.setImageResource(R.drawable.btn_new_shutter);
    ...
    public void updateControlsRes(int orientation) {
        Log.d(TAG, "updateControlsRes orientation="+orientation);
        if (orientation == Configuration.ORIENTATION_PORTRAIT) {
            mShutterButton.setImageResource(R.drawable.btn_pano_shutter_port);
        } else {
            mShutterButton.setImageResource(R.drawable.btn_pano_shutter_land);
        }
    }
}
