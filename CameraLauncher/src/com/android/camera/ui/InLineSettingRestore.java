 ...
 */
/*Created by Spreadst for restore*/
...
public class InLineSettingRestore extends InLineSettingItem {
    ...
    // fixed bug 125653 start
    @Override
    public void reloadPreference() {
        /*
         * Must override "reloadPrefence()" method
         * Cause parent class will be use "mPreferences" object,
         * but this class haven't "mPreference" object, so if not override,
         * will be throw "NullPointerException".
         * (Please see "getView()" method in the "OtherSettingsPopup" class)
         */
    }
    // fixed bug 125653 end
}
