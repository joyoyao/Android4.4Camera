...
public class CameraRootView extends FrameLayout {
    ...
    public void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            } else if(v instanceof CameraControlsTop){
                CameraControlsTop cameraControlsTop = (CameraControlsTop)v;
                cameraControlsTop.golayout(l + mLeftMargin, t + mTopMargin, r - mRightMargin, b - mBottomMargin);
            } else if(v instanceof VideoControlsTop){
                VideoControlsTop videoControlsTop = (VideoControlsTop)v;
                videoControlsTop.golayout(l + mLeftMargin, t + mTopMargin, r - mRightMargin, b - mBottomMargin);
            } else if(v instanceof ModuleSwitcherView) {
                ModuleSwitcherView moduleSwitcherView = (ModuleSwitcherView)v;
                moduleSwitcherView.onLayoutTextView(changed, l, t, r, b);
            } else {
