...
public abstract class InLineSettingItem extends LinearLayout {
    ...
    /* SPRD: Set disable item title color to gray @{ */
    public void setTitleDisableColor(ListPreference preference) {
        mTitle = ((TextView) findViewById(R.id.title));
        mTitle.setTextColor(R.color.item_gray);
    }
    /* @} */
