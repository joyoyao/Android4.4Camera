...
public abstract class AbstractLocalDataAdapterWrapper implements LocalDataAdapter {
    ...
    public void requestSecureImageLoad(){
        mAdapter.requestSecureImageLoad();
    }
    ...
    // SPRD: bug 256269 set the module which need the DataAdapter
    @Override
    public void setAdapterModule(int module) {
        mAdapter.setAdapterModule(module);
    }

    // SPRD: bug 256269 get firstData from DataAdapter
    @Override
    public LocalData getFirstData() {
        return mAdapter.getFirstData();
    }

    // SPRD: bug 256269 updata DataAdapter
    @Override
    public void UpdataAdapter() {
        mAdapter.UpdataAdapter();
    }

    @Override
    public String getLastVideoPath() {
        return mAdapter.getLastVideoPath();
    }

    @Override
    public String getImageLastPath() {
        return mAdapter.getImageLastPath();
    }

    @Override
    public void setLastThumbnailPath(String imagepath, String videopath) {
        mAdapter.setLastThumbnailPath(imagepath, videopath);
    }
