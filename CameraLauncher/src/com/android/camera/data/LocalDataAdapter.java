...
public interface LocalDataAdapter extends DataAdapter {
    ...
    /** Update Adapter when camera module changed. */
    public void UpdataAdapter();

    /**
     * Set the module which need update the Adapter.
     *
     * @param module The module index of which need update the Adapter
     */
    public void setAdapterModule(int module);

    /**
     * Get the first Data of the DataAdapter.
     *
     * @return the first LocalData of the DataAdapter
     */
